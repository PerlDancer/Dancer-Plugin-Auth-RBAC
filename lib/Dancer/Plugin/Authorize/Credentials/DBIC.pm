# ABSTRACT: Dancer::Plugin::Authorize authentication via the Dancer::Plugin::DBIC!

package Dancer::Plugin::Authorize::Credentials::DBIC;
        ...
        auth: # keyword allows one to setup multiple authentication schemes
          credentials:
            ...
            options:
              ...
              roles:
                resultset: UserRoles
                user: user_id             # database field that references the user account identifier
                role: role_name           # role name database field

=head1 DESCRIPTION

Dancer::Plugin::Authorize::Credentials::DBIC uses your Dancer::Plugin::DBIC 
...
If you opt to create a database structure similar to the example above, you should
create a 
